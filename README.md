...
| #2 | 产品功能与交互设计 | 题库能力归纳、智能问数页面原型和分析工作台原型 |
| #3 | 前端实现与产品集成 | 统一结果结构、智能问数页面、公共结果组件和分析记录闭环 |
| #4 | 五张官方表的数据审计、规范化入库与查询底座建设 | 数据审计、正式Schema、可重复导入、质量对账和查询验证 |
| #5 | 官方题库语义映射、衍生口径整理与题库异常审核 | 题库表达映射、衍生与复合口径、异常审核与技术交接 |
| #6 | 官方题库批量评测、错误归因与版本回归验收 | 官方答案判分、专项测试、失败归因和版本差异 |
...
- [评测规范](docs/评测规范.md)
- [02号产品功能与交互设计](docs/02_产品功能与交互设计.md)
- [03号前端实现与产品集成](docs/03_前端实现与产品集成.md)
