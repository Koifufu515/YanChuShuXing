(function (global) {
  ...
  const tooltip = { backgroundColor: "#fff", borderColor: "#E5E8EE", padding: [6, 9], textStyle: { color: "#172033", fontSize: 12, lineHeight: 16 }, extraCssText: "box-shadow:0 4px 16px rgba(16,24,40,.1);border-radius:7px;max-width:260px;" };
